...
require("./modules/video/video.js");
require("./modules/tabs/tabs.js");
require("./modules/faq/faq.js");
require("./modules/smooth-scroll/smooth-scroll.js");
// ---------------------------------
...
},{"./modules/faq/faq.js":2,"./modules/form-validate/form.js":4,"./modules/modals/init-modals.js":10,"./modules/smooth-scroll/smooth-scroll.js":12,"./modules/tabs/tabs.js":13,"./modules/video/video.js":14,"./utils/ios-vh-fix.js":17}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.detailsDetails = void 0;
var detailsDetails = document.querySelectorAll('[data-anwers-details]');
exports.detailsDetails = detailsDetails;
var answers = document.querySelectorAll('[data-anwers]');
var faqBlock = document.querySelector('[data-faq-block]');
var faqBtn = document.querySelectorAll('[data-faq-btn]');
detailsDetails.forEach(function (detailsItem) {
  var answersSummary = detailsItem.querySelector('[data-answers-summary]');
  answersSummary.addEventListener('click', function () {
    var answersReply = detailsItem.querySelector('[data-answers-reply]');
...
answers.forEach(function (tabList, index) {
  var dataAttr = "faq-".concat(index + 1);
  tabList.setAttribute('data-faq', dataAttr);
});
var clearFaqBtn = function clearFaqBtn(button) {
  faqBtn.forEach(function (element) {
    return element.classList.remove('is-active');
  });
  button.classList.add('is-active');
};
var onControlFaqClick = function onControlFaqClick(evt) {
  var target = evt.target.closest('.faq__btn');
  if (!target) {
    return;
  }
  clearFaqBtn(target);
  var targetId = evt.target.id;
  answers.forEach(function (tabItem) {
    var dataFaqValue = tabItem.getAttribute('data-faq');
...
var anchorLink = document.querySelector('[data-hero-btn]');
exports.anchorLink = anchorLink;
anchorLink.addEventListener('click', function (event) {
  event.preventDefault();
  var targetId = anchorLink.getAttribute('href');
...
exports.tabsContentItems = exports.tabsContentBtns = void 0;
var tabsContentItems = document.querySelectorAll('[data-tabs-content-item]');
exports.tabsContentItems = tabsContentItems;
var tabsContentBtns = document.querySelectorAll('[data-tabs-content-btn]');
exports.tabsContentBtns = tabsContentBtns;
var tabLists = document.querySelectorAll('[data-tabs-content-list]');
var controlButton = document.querySelectorAll('[data-tabs-control-btn]');
var tabsControl = document.querySelector('[data-tabs-control]');
tabsContentItems.forEach(function (tabsContentItem, index) {
  var tabsContentBtn = tabsContentBtns[index];
  tabsContentItem.addEventListener('mouseover', function () {
    tabsContentBtn.classList.add('is-active');
  });
  tabsContentItem.addEventListener('mouseout', function () {
    tabsContentBtn.classList.remove('is-active');
  });
});
tabLists.forEach(function (tabList, index) {
  var dataAttr = "tab-".concat(index + 1);
  tabList.setAttribute('data-tab', dataAttr);
});
var clearFilter = function clearFilter(button) {
  controlButton.forEach(function (element) {
    return element.classList.remove('is-active');
  });
  button.classList.add('is-active');
};
var onControlTabClick = function onControlTabClick(evt) {
  var target = evt.target.closest('.tabs-control__button');
  if (!target) {
    return;
  }
  clearFilter(target);
  var targetId = evt.target.id;
  tabLists.forEach(function (tabItem) {
    var dataTabValue = tabItem.getAttribute('data-tab');
...
exports.playButton = exports.gymVideoLink = void 0;
var playButton = document.querySelector('#play-button');
exports.playButton = playButton;
var gymVideoLink = document.querySelector('[data-gym__video]');
exports.gymVideoLink = gymVideoLink;
var videoHTML = '<iframe src="https://www.youtube.com/embed/9TZXsZItgdw" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
gymVideoLink.addEventListener('click', function (event) {
  event.preventDefault();
  playButton.remove();
  gymVideoLink.innerHTML = videoHTML;
  var gymVideo = document.querySelector('[data-gym__video] iframe');
